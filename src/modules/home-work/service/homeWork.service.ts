...
export class HomeWorkService {
  ...
  async listHomeWorksByTeacher(
    ...
    try {
      ...
      where "classId" = cs.id) as qtdStudents, (select count(distinct ed."studentId") from "EvaluativeDelivery" ed where ed."homeWorkId" = hw.id and ed."owner"::text = 'Estudante' and ed.stage in ('Enviada', 'Avaliada')) as qtdSubmissions FROM "HomeWork" hw, "Discipline" ds, "Class" cs
